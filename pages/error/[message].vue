                    ...
                    <div class="absolute">
                        <div class="flex flex-col gap-y-4 items-start">
                            <h1 class=" text-gray-800 font-bold text-2xl">
                             ...
                             <p class=" text-gray-800 font-medium">Probable cause : {{ route.params.message }}</p>
                            <p class=" text-gray-800">Sorry about that! Please visit our hompage to get where you need to go.</p>
                            <!-- <p class="my-2 text-gray-800">{{ error.url}}</p> -->
                            ...
                            <UButton label="Take me there" class="py-2 px-4" to="/"/>
                        </div>
                    </div>
                    <div>
